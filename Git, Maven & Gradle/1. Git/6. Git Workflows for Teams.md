...
```bash
# ✅ DO: Always branch from latest main
git checkout main
git pull origin main
git checkout -b feature/new-feature

# ❌ DON'T: Branch from outdated main
git checkout main
# (main is 2 weeks old)
git checkout -b feature/new-feature
...
# ✅ DO: One feature per branch
git checkout -b feature/add-email-validation

# ❌ DON'T: Multiple unrelated features
...
# ❌ DON'T: Only explain WHAT (code shows what)
...
// ✅ GOOD Review Comment
"This O(n²) loop could be optimized. Since we're just checking
...
This improves time complexity from O(n²) to O(n)."
...
→ Squash to: "fix: Correct typo in user service"
...
□ Does subject line describe WHAT changed?
□ Does body explain WHY?
□ Is it clear how this helps?
...
□ No TODO comments (or tracked in tickets)
...
□ No merge conflicts
□ Unnecessary files not committed (.class, .idea, etc.)
```
...
───────────────────
❌ Cannot merge
Fix issues → Push update → Checks run again
```
...
- ✅ **Feature branches**: Descriptive names following conventions
- ✅ **Commits**: Atomic, conventional, well-documented
- ✅ **Pushing**: Set upstream, push regularly
- ✅ **PR creation**: Clear title, comprehensive description
- ✅ **Code review**: Constructive feedback, multiple reviewers
- ✅ **Addressing feedback**: Professional, timely responses
- ✅ **Merging**: Choose appropriate strategy (merge/squash/rebase)

### Code Review Best Practices

- ✅ **Small PRs**: < 200 lines ideal, split large features
- ✅ **Clear messages**: Explain WHY, provide context
- ✅ **Self-review**: Check your own code first
- ✅ **Feedback**: Respond professionally and constructively

### Branch Protection Rules

- ✅ **PR reviews**: Require approvals before merging
- ✅ **Status checks**: CI/CD must pass
- ✅ **Linear history**: Enforce clean commit history
- ✅ **No force push**: Protect main branch from rewrites
- ✅ **CODEOWNERS**: Require appropriate team reviews
